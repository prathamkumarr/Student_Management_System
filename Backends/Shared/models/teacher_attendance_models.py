from sqlalchemy import(
    Integer, String, Date, DateTime, Enum, ForeignKey, 
    func, UniqueConstraint, Boolean, CheckConstraint, Index
)
...
class TeacherAttendance(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "(check_out IS NULL OR check_in IS NOT NULL)",
            name="ck_checkout_requires_checkin"
        ),
