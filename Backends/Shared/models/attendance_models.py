...
class AttendanceRecord(Base):
    ...
    subject: Mapped["SubjectMaster"] = relationship("SubjectMaster", back_populates="attendance_records")
    class_ref: Mapped["ClassMaster"] = relationship("ClassMaster", back_populates="attendance_records")
    teacher: Mapped["TeacherMaster"] = relationship("TeacherMaster", back_populates="student_attendance_records")
